...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\askwhichbrowserwindow on
     Windows, /home/user/dev/askwhichbrowserwindow on Linux) in a file named
     askwhichbrowserwindow@bryan.clark and copy that file to
